...
function draw(e) {
    ...
    //sword rotation (only gets called if the mouse is clicked) this stuff was a fucking pain
    if(md){
        if(swordCooldown < 0){
...
// this was a fucking pain in the ass I never want to make games in dogshit js again
// C based stuff next ig
